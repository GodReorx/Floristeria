...
public class GardenElementsMySQL<T extends GardenElements> implements GenericDAO {
    ...
    public List<GardenElements> allGardenElements(int idFlowerStore) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement("Select * from GardenElements left join Stock on GardenElements.idGardenElements = Stock.GardenElementsId and Stock.FlowerShopId = ?;")) {
